...
<html lang="pl-PL">
	...
	<title>Zaloguj się &lsaquo; jakozak1.netlify.app &#8212; WordPress</title>
...
<link rel="stylesheet" id="login-css" href="/wp-admin/css/login.min.css?ver=6.1.1" media="all">
	...
	<script type="text/javascript">document.body.className = document.body.className.replace('no-js','js');</script>
		...
		<form name="loginform" id="loginform" action="http://localhost/czesc/wp-login.php" method="post">
			<p>
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Zaloguj się">
									<input type="hidden" name="redirect_to" value="http://localhost/czesc/wp-admin/">
									<input type="hidden" name="testcookie" value="1">
			</p>
		</form>

					<p id="nav">
				<a href="/wp-login.php?action=lostpassword">Nie pamiętasz hasła?</a>			</p>
...
if ( typeof wpOnload === 'function' ) { wpOnload() }</script>
				<p id="backtoblog">
			<a href="/">&larr; Przejdź do jakozak1.netlify.app</a>		</p>
			</div>
...
<script id="zxcvbn-async-js-extra">var _zxcvbnSettings = {"src":"httplocalhost\/czesc\/wp-includes\/js\/zxcvbn.min.js"};</script>
